...
namespace NClass.DiagramEditor
{
    ...
    public sealed class Style : IDisposable
    {
        ...
        {
            if (systemBoundaryFont != null) return;

            systemBoundaryBorderWidth = 1;
        ...
        public static IEnumerable<Style> AvaiableStyles => styles.Values;
        ...
        #region  System Boundary Properties
        [DisplayName("Border Width"), Category("System Boundary")]
        [Description("The border width of the system boundary.")]
        [DefaultValue(1)]
        public int SystemBoundaryBorderWidth
        {
            get => systemBoundaryBorderWidth;
            set => systemBoundaryBorderWidth = value < 1 ? 1 : value;
        }

        [DisplayName("Background Color"), Category("System Boundary")]
        [Description("The background color for the system boundary.")]
        [DefaultValue(typeof(Color), "White")]
        public Color SystemBoundaryBackColor
        {
            get => systemBoundaryBackColor;
            set => systemBoundaryBackColor = value;
        }

        [DisplayName("Border Color"), Category("System Boundary")]
        [Description("The border color for the system boundary.")]
        [DefaultValue(typeof(Color), "Black")]
        public Color SystemBoundaryBorderColor
        {
            get => systemBoundaryBorderColor;
            set => systemBoundaryBorderColor = value;
        }

        [DisplayName("Font"), Category("System Boundary")]
        [Description("The font of the displayed text for the system boundary.")]
        public Font SystemBoundaryFont
        {
            get => this.systemBoundaryFont;
            set
            {
                if (value != null && systemBoundaryFont != value)
                {
                    systemBoundaryFont?.Dispose();
                    systemBoundaryFont = value;
                }
            }
        }

        [DisplayName("Text Color"), Category("System Boundary")]
        [Description("The text color for the system boundary.")]
        [DefaultValue(typeof(Color), "Black")]
        public Color SystemBoundaryTextColor
        {
            get => systemBoundaryTextColor;
